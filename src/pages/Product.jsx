      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            cumque quis ullam veniam. Quis alias mollitia minus non, dolore quod
            et rem ipsa temporibus, cum ratione nihil distinctio repudiandae
            ipsum.
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Labore
            officia qui distinctio sed necessitatibus similique quos veritatis.
            Dicta deleniti ea voluptatibus debitis! Velit excepturi omnis illo
            sunt, culpa fuga nostrum.
          </p>
        </div>
      </div>
